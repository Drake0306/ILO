...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'Remarks', alignRight: false },
...
export default function Remarks() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/master/remarks/${url}`, { replace: true });
    }
  }
  ...
  return (
    <Page title="Different Remarks">
      ...
      <Container maxWidth="">
        ...
        <Card>
          <UserListToolbar selected={selected} data={USERLIST} searchName={"Remarks"} numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} />
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu urlTo={'/app/master/remarks/newEntry/'} data={row} dataID={id} deleteURL={'master/differentRemarks/delete/'} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
