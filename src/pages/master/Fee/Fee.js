...
const TABLE_HEAD = [
  ...
  { id: 'FeeinRs', label: 'Fee in Rs', alignRight: false },
...
export default function Fee() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/master/fee/${url}`, { replace: true });
    }
  }

  useEffect(() => {
    axios.get(`${JSON_CONST.DB_URL}master/fee/list`)
     .then((response) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu urlTo={'/app/master/fee/newEntry/'} data={row} dataID={id} deleteURL={'master/fee/delete/'} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
