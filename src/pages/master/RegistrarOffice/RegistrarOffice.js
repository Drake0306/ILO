...
export default function RegistrarOffice() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/master/registrarOffice/${url}`, { replace: true });
    }
  }
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu urlTo={'/app/master/registrarOffice/newEntry/'} data={row} dataID={id} deleteURL={'master/registrarOffice/delete/'} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
