...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'DSA Name', alignRight: false },
...
export default function Dsa() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/master/dsa/${url}`, { replace: true });
    }
  }
  ...
  return (
    <Page title="DSA">
      <Container maxWidth="">
        ...
        <Card sx={{ width: '100%' }}>
          <UserListToolbar selected={selected} data={USERLIST} searchName={"DSA Name"} numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} />
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, address, phone, status, avatarUrl, dsa } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu urlTo={'/app/master/dsa/newEntry/'} data={row} dataID={id} deleteURL={'master/DSA/delete/'} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
