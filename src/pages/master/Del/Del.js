...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'Del Name', alignRight: false },
...
export default function Del() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/master/del/${url}`, { replace: true });
    }
  }
  ...
  return (
    <Page title="Del">
      <Container maxWidth="">
        ...
        <Card>
          <UserListToolbar selected={selected} data={USERLIST} searchName={"Del Name"} numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} />
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu urlTo={'/app/master/del/newEntry/'} data={row} dataID={id} deleteURL={'master/delTable/delete/'} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
