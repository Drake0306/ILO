...
export default function ListAL() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/format/AuthorityLetters/${url}`, { replace: true });
    }
  }
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">
                            <UserMoreMenu urlTo={'/app/format/AuthorityLetters/'} data={row} dataID={id} deleteURL={'disbursal/registration/delete/'} />
                          </TableCell>
                        </TableRow>
                      );
                    })}
