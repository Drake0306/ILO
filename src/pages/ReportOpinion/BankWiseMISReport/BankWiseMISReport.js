...
export default function BankWiseMISReport(props) {
  ...
  const onSubmit = async (event) => {
    ...
    let sendPost = {
      ...
      caseRecived: fromElementsData.caseRecived.checked,
      caseSent: fromElementsData.caseSent.checked,
      casePending: fromElementsData.casePending.checked,
      caseHold: fromElementsData.caseHold.checked,
    }

    sendPost = JSON.stringify(sendPost);
    sendPost = encodeURI(sendPost);

    navigate(`/app/reportOpinion/bankWiseMISReport/PDFRenderBankWiseMISReport/${sendPost}`, { replace: true,  });
  ...
  return (
    <Page title="Bank Wise MIS Report">
      <Container maxWidth="xl">
        {/* <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <Typography variant="h4" gutterBottom>
          Bank Wise MIS Report
          </Typography>
