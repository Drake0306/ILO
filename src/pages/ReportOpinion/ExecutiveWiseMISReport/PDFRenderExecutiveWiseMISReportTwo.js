...
export default function PDFRenderExecutiveWiseMISReportTwo (props) {
    ...
    const exportToExcel = async () => {
        ...
        FileSaver.saveAs(data, `Export All EXECUTIVE Wise Cases Received${fileExtension}`);
    }
        ...
        <>
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                    <Button style={{backgroundColor: 'black', color: 'white'}} onClick={(e) => redirectPage('reportOpinion/executiveWiseMisReport/0')} size="medium"> ← Back</Button>
                    </Grid>
                    <Grid item xs={6}>
