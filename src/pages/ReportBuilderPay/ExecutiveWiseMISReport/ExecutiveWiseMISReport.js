...
export default function ExecutiveWiseMISReport(props) {
  ...
  const onSubmit = async (event) => {
    ...
    navigate(`/app/reportBuilderPay/executiveWiseMISReport/PDFRenderExecutiveWiseMISReport/${sendPost}`, { replace: true,  });
  };
  ...
  return (
    <Page title="Executive Wise MIS Report">
      <Container maxWidth="xl">
        {/* <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <Typography variant="h4" gutterBottom>
          Executive Wise MIS Report
          </Typography>
          ...
          <Grid container alignItems="center" paddingLeft={10} paddingBottom={10} paddingRight={10} paddingTop={5} spacing={3}>
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <FormControl fullWidth>
                <InputLabel id="executive-select-label">Executive</InputLabel>
                <Select
                  labelId="executive-select-label"
                  id="executive-select"
                  value={fromData.executive}
                  label="executive"
                  name="executive"  
                  fullWidth
                  onChange={onChangeFields}
