...
export default function PaymentLedger(props) {
  ...
  const onSubmit = async (event) => {
    ...
    navigate(`/app/reportBuilderPay/paymentLedger/PDFRenderPaymentLedger/${sendPost}`, { replace: true,  });
      ...
      <Container maxWidth="xl">
        ...
        <Card>
          <Grid container alignItems="center" paddingLeft={10} paddingBottom={10} paddingRight={10} paddingTop={5} spacing={3}>
            ...
            <Grid item xs={12} sm={12} md={4} mt={0} lg={4}>
            ...
            <Grid item xs={12} sm={12} mt={0} md={4} lg={4}>
              <FormControl fullWidth>
            ...
            <FormControl>
                ...
                >
                    <FormControlLabel value="1" required control={<Radio name="recDate" />} label="Receive Date" />
                    <FormControlLabel value="2" required control={<Radio name="sentDate" />} label="Sent on Date" />
                </RadioGroup>
            </FormControl>
            </Grid>
