...
const TABLE_HEAD = [
  ...
  { id: 'customerName', label: '*CustomerName', alignRight: false , search: true},
  { id: 'date', label: 'Reg Date', alignRight: false , search: false},
  // { id: 'address', label: 'Address', alignRight: false , search: true},
  { id: 'phoneNo', label: '*Phone', alignRight: false , search: true},
