...
const TABLE_HEAD = [
  ...
  { id: 'transNo', label: '*Transaction No', alignRight: false, search: true },
  { id: 'name', label: '*Bank Name', alignRight: false, search: true },
  { id: 'branch', label: '*Branch Name', alignRight: false, search: true },
  { id: 'registrationDate', label: 'Reg Date', alignRight: false, search: false },
  // { id: 'address', label: 'Address', alignRight: false, search: true },
  { id: 'purchaser', label: '*Purchaser', alignRight: false, search: true },
  { id: 'phoneMobile', label: '*Phone', alignRight: false, search: true },
  { id: 'applicationNo', label: '*App No', alignRight: false, search: true },
...
export default function ListRegistration() {
  ...
  const redirectPage = async (url) => {
    if(url === "homepage") {
      ...
      navigate(`/app/disbursal/registration/${url}`, { replace: true });
    }
  }
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu urlTo={'/app/disbursal/registration/newEntry/'} data={row} dataID={id} deleteURL={'disbursal/registration/delete/'} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
