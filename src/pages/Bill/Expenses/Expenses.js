...
export default function Expenses(props) {
  ...
  const onBill = () => {
    navigate(`/app/bill/expenses/PDFRenderBillExpenses/${0}`, { replace: true,  });
  }
  
  const onSupportings = () => {
    navigate(`/app/bill/expenses/PDFRenderSupportingsExpenses/${0}`, { replace: true,  });
  }
        ...
        <Card>
          <Grid container alignItems="center" paddingLeft={10} paddingBottom={10} paddingRight={10} paddingTop={5} spacing={3}>
            ...
            <Grid item xs={12} sm={1} md={3} lg={3}>
              <LoadingButton fullWidth size="large" type="button" onClick={onBill} variant="outlined" color="info" loading={isSubmitting}>
                Bill
              </LoadingButton>
            </Grid>
            <Grid item xs={12} sm={1} md={3} lg={3}>
