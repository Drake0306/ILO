...
export default function PDFRenderLoanLedger (props) {
    ...
    const exportToExcel = async () => {
        ...
        FileSaver.saveAs(data, `Export INTELLECTIVE LAW OFFICES Loan Taken Over Register${fileExtension}`);
    }
        ...
        <>  
            {isLoading ? (
                    ...
                    <Box sx={{ flexGrow: 1 }}>
                        ...
                        <Grid item xs={12}>
                        <Button style={{backgroundColor: 'black', color: 'white'}} onClick={(e) => redirectPage('reportDisbursal/loanLedger/0')} size="medium"> ← Back</Button>
                        </Grid>
                            <Grid item xs={6}>
