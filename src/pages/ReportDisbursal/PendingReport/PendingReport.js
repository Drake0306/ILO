...
export default function PendingReport(props) {
  ...
  const onSubmit = async (event) => {
    ...
    let sendPost = {
      registrarOff: fromElementsData.registrarOffice.value,
      regiLedger: true,
      loanLedger: false,
    }
    ...
    navigate(`/app/reportDisbursal/PDFRenderPendingReport/${sendPost}`, { replace: true,  });
...
{/*             
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <FormControl fullWidth>
                <InputLabel id="registrarOffice-select-label">Registrar Office</InputLabel>
                <Select
                  labelId="registrarOffice-select-label"
                  id="registrarOffice-select"
                  value={fromData.registrarOffice}
