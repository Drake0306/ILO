                                        ...
                                        <table border={0} className="tableTwo">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th rowSpan={2} className='borderLine' style={{width: '70px'}}><h5>Reg Date</h5></th>
                                                    <th rowSpan={2} className='borderLine' style={{width: '70px'}}><h5>Registrar Office</h5></th>
                                                    <th rowSpan={2} className='borderLine' style={{width: '70px'}}><h5>Property Details</h5></th>
                                                    <th rowSpan={2} className='borderLine' style={{width: '200px'}}><h5>R.D Sent</h5></th>
                                            ...
                                            {resData.map((row) => (
                                                <tr key={row.id}>
                                                    ...
                                                    <td className='borderLine' style={{fontSize: '9px', textAlign: 'left'}}> {row?.checqueDate && moment(row?.checqueDate).format('DD-MM-YYYY')} </td>                                                        
                                                    <td className='borderLine' style={{fontSize: '9px', textAlign: 'left'}}> {row?.chequeRecivedDate && moment(row?.chequeRecivedDate).format('DD-MM-YYYY')} </td>                                                        
