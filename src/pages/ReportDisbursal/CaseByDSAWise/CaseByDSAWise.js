...
export default function CaseByDSAWise(props) {
  ...
  const onSubmit = async (event) => {
    ...
    navigate(`/app/reportDisbursal/caseByDSAWise/PDFRenderCaseByDSAWise/${0}`, { replace: true,  });
