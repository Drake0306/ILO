...
export default function ExutivePeformanceSummary(props) {
  ...
  const onSubmit = async (event) => {
    ...
    let sendPost = {
      caseHandlledBy: fromElementsData.caseHandlledBy.value,
    ...
    navigate(`/app/reportDisbursal/exutivePeformanceSummary/PDFRenderExutivePeformanceSummary/${sendPost}`, { replace: true,  });
  ...
  return (
    <Page title="Exutive Peformance Summary">
      <Container maxWidth="xl">
        {/* <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <Typography variant="h4" gutterBottom>
          Exutive Peformance Summary
          </Typography>
          ...
          <Grid mt={2} mb={0} item xs={12} sm={12} md={12} lg={12}>
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <FormControl fullWidth>
                <InputLabel id="caseHandlledBy-select-label">Case Handlled By</InputLabel>
                <Select
                  labelId="caseHandlledBy-select-label"
                  id="caseHandlledBy-select"
                  value={fromData.caseHandlledBy}
                  label="caseHandlledBy"
                  name="caseHandlledBy"  
                  fullWidth
