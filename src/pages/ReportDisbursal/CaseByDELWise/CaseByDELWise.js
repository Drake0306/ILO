...
export default function CaseByDELWise(props) {
  ...
  const onSubmit = async (event) => {
    ...
    navigate(`/app/reportDisbursal/caseByDELWise/PDFRenderCaseByDELWise/${0}`, { replace: true,  });
          ...
          <Grid mt={2} mb={0} item xs={12} sm={12} md={12} lg={12}>
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <FormControl fullWidth>
                <InputLabel id="del-select-label">DEL</InputLabel>
                <Select
                  labelId="del-select-label"
                  id="del-select"
                  value={fromData.del}
                  label="del"
                  name="del"  
