...
export default function PDFRenderAccountSummary (props) {
    ...
    const exportToExcel = async () => {
        ...
        FileSaver.saveAs(data, `Export INTELLECTIVE LAW OFFICES Account Summary${fileExtension}`);
    }
    ...
    return (
        <>
            <Box sx={{ flexGrow: 1 }}>
                ...
                <Grid item xs={12}>
                    <Button style={{backgroundColor: 'black', color: 'white'}} onClick={(e) => redirectPage('reportDisbursal/accountSummary/0')} size="medium"> ← Back</Button>
                    </Grid>
                    <Grid item xs={6}>
