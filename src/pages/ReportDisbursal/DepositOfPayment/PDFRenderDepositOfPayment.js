...
export default function PDFRenderDepositOfPayment (props) {
    ...
    const exportToExcel = async () => {
        ...
        FileSaver.saveAs(data, `Export INTELLECTIVE LAW OFFICES Deposit Of Payment${fileExtension}`);
    }
            ...
            {isLoading ? (
                <Loader />
                    ...
                    <Box sx={{ flexGrow: 1 }}>
                        ...
                        <Grid item xs={12}>
                        <Button style={{backgroundColor: 'black', color: 'white'}} onClick={(e) => redirectPage('reportDisbursal/depositOfPayment/0')} size="medium"> ← Back</Button>
                        </Grid>
                            <Grid item xs={6}>
