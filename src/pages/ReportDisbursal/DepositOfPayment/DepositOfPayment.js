...
export default function DepositOfPayment(props) {
  ...
  const onSubmit = async (event) => {
    ...
    if(typeof props.name !== 'undefined') {
      ...
      navigate(`/app/reportDisbursal/depositOfPayment/PDFRenderDepositOfPayment/${sendPost}`, { replace: true,  });
    } else {
