...
export default function LoanRegistrationCaseHandledBy(props) {
  ...
  const onSubmit = async (event) => {
    ...
    let sendPost = {
      ...
      caseHandledBy: fromElementsData.caseHandledBy.value,
      ...
      pending: fromElementsData.pending.checked,
    }

    sendPost = JSON.stringify(sendPost);
    sendPost = encodeURI(sendPost);

    navigate(`/app/reportDisbursal/loanRegistrationCaseHandledBy/PDFRenderLoanRegistrationCaseHandledBy/${sendPost}`, { replace: true,  });
  };
  ...
  return (
    <Page title="Loan Registration Case Handled By">
      <Container maxWidth="xl">
        {/* <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <Typography variant="h4" gutterBottom>
          Loan Registration Case Handled By
          </Typography>
          ...
          <Grid mt={2} mb={0} item xs={12} sm={12} md={12} lg={12}>
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <FormControl fullWidth>
                <InputLabel id="caseHandledBy-select-label">Case Handled By</InputLabel>
                <Select
                  labelId="caseHandledBy-select-label"
                  id="caseHandledBy-select"
                  value={fromData.caseHandledBy}
                  label="caseHandledBy"
                  name="caseHandledBy"  
                  fullWidth
            ...
            {/* <Grid mt={2} mb={2} item xs={12} sm={12} md={12} lg={12}>
              <Typography variant="overline" gutterBottom>
               Date<Iconify icon="bi:arrow-down" />
              </Typography>
            </Grid> */}
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <TextField
